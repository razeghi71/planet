...
public class GraphicalWorld implements GraphicEngine {
	...
	public GraphicalWorld() {
		...
		try {
			spaceship_blue = ImageIO.read(getClass().getResource(
					"/resources/Spaceship_blue.png"));
			spaceship_red = ImageIO.read(getClass().getResource(
					"/resources/Spaceship_red.png"));
		} catch (IOException e) {
	...
	public void addSoldier(Soldier soldier) {
		...
		pl.setLocation((int) (soldier.getPosition().getX() - width / 2),
				(int) (soldier.getPosition().getY() - height / 2));
		...
		imageForOne = new ImageIcon(rotate(resize(image, width, height),
				soldier.getPosition(), soldier.getDest().getPosition()));
	...
	public void updateSoldier(Soldier soldier) {
		...
		pl.setLocation(
				(int) (soldier.getPosition().getX() - pl.getWidth() / 2),
				(int) (soldier.getPosition().getY() - pl.getHeight() / 2));
		JLabel text = new JLabel();
		text.setText(soldier.getStrenght() + "");
	...
	public void addPlanet(Planet planet) {
		...
		pl.setLocation(
				(int) (planet.getPosition().getX() - planet.getDiameter() / 2),
				(int) (planet.getPosition().getY() - planet.getDiameter() / 2));
		pl.setName(planet.getOwner());

		ImageIcon imageForOne = null;
		if (planet.getOwner().equals("Blackhole")) {
			try {
				imageForOne = new ImageIcon(resize(
						ImageIO.read(getClass().getResource(
								"/resources/Black-hole.png")),
			...
			text.setHorizontalAlignment(SwingConstants.CENTER);
			text.setText("<html><font color='white' size="
					+ planet.getDiameter() / 15 + ">"
					+ planet.getNumerOfSoldiers() + "</font></html>");
	...
	public void updatePlanet(Planet planet) {
		...
		text.setText("<html><font color='white' size=" + planet.getDiameter()
				/ 15 + ">" + planet.getNumerOfSoldiers() + "</font></html>");
		pl.add(text);
	...
	public void setGameInfo(int team1Soldiers, int team2Soldiers) {
		...
		double p1_d = (double) (team1Soldiers)
				/ (team1Soldiers + team2Soldiers);
		title1.setBounds(0, 0, (int) (window.getWidth() * p1_d), 50);
//		team1_soldiers.setBounds(0, 45, (int) (window.getWidth() * p1_d / 2), 5);

		double p2_d = (double) (team2Soldiers)
				/ (team1Soldiers + team2Soldiers);
		title2.setBounds((int)(window.getWidth() * p1_d), 0,(int) (window.getWidth() * p2_d), 50);
//		team2_soldiers.setBounds((int)(window.getWidth() * p1_d / 2), 0,(int) (window.getWidth() * p2_d / 2), 50);
